...
namespace KYMBusinessSolutions
{
    public partial class Buy : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT itemID, itemName, itemDesc, UOM, ItemCost, OnHandQuantity, materialCode, SupplierID FROM Inventory where materialcode = 'M'";
        ...
        protected void BuyItemsGridView_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            int SupplierID = (int)BuyItemsGridView.DataKeys[index].Values["SupplierID"];

            Response.Redirect("PlaceOrder.aspx?ItemID=" + ItemID + "&ItemName=" + ItemName + "&ItemDesc=" + ItemDesc + "&UOM=" + UOM
                + "&ItemCost=" + ItemCost + "&MaterialCode=" + MaterialCode + "&OnHandQuantity=" + OnHandQuantity + "&SupplierID=" + SupplierID);
