<%@ Page Language="C#" AutoEventWireup="true"  CodeBehind="Buy.aspx.cs" Inherits="KYMBusinessSolutions.Buy"  %>
...
.m1 ul li a:hover
{
    ...
    font-size:24px;
        ...
        <asp:GridView ID="BuyItemsGridView" Runat="server"   
            ...
            DataKeyNames="ItemID,ItemName,ItemDesc,UOM,ItemCost,MaterialCode,OnHandQuantity,SupplierID" AutoGenerateColumns="False" 
             BorderWidth="1px" BackColor="White" 
             CellPadding="3" cellWidth="20px" BorderStyle="Solid" 
             BorderColor="#999999" GridLines="Vertical" OnRowCommand="BuyItemsGridView_RowCommand" OnSelectedIndexChanged="BuyItemsGridView_SelectedIndexChanged" CssClass="auto-style14" ForeColor="Black" Width="1314px" >
            <FooterStyle 
