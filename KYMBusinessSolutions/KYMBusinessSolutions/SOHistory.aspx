<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SOHistory.aspx.cs" Inherits="KYMBusinessSolutions.SOHistory" %>
 ...
 <br />
    ...
    <asp:GridView ID="SOGridView" Runat="server"   
            ...
            DataKeyNames="SONumber" AutoGenerateColumns="False" 
             ...
             BorderColor="#999999" GridLines="Vertical" CssClass="auto-style2" Width="942px" ForeColor="Black">
            <FooterStyle 
