<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editSupplierRecord.aspx.cs" Inherits="KYMBusinessSolutions.editSupplierRecord" %>
...
<html>
  ...
  <form id="SupplierEditForm" runat="server">
          ...
          <table id="values" cellpadding="2" style="background-color:#56789A">
            ...
            <tr>
              <td align="right">
                  Supplier ID:</td>
              <td align="left">
                <asp:TextBox id="supplierIDtbx" runat="server"  MaxLength="255" />
              </td>
            </tr>
...
<script language="C#" runat="server">
  ...
  void Page_Load(Object sender, EventArgs e)
  {
    ...
    lblSupplierID2.text = Context.User.Identity.Name;
    ...
    {       
          try
          {
            ...
            string query = "select * from supplier where supplierID='" + suppID + "'";
            ...
            supplierIDtbx.BackColor = System.Drawing.Color.LightGray;
            supplierIDtbx.ReadOnly = true;
            supplierIDtbx.TextBoxMode.SingleLine;
            supplierIDtbx.Text = (string) values[0];           
  ...
  void save(Object sender, EventArgs e)
  {
    ...
    query = @"UPDATE supplier SET SupplierBusiness_Name='" + BusinessNametbx.Text + @"', ContactFname='" + fnametbx.Text + @"', ContactLname='"
        ...
        telephonetbx.Text+ @"' WHERE supplierID='" + supplierIDtbx.text + "'";
