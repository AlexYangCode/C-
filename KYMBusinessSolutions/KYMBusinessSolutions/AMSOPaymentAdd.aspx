<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AMSOPaymentAdd.aspx.cs" Inherits="KYMBusinessSolutions.AMSOPaymentAdd" %>
...
<form id="form1" runat="server">
        ...
        <table style="BORDER-RIGHT: 0px solid; BORDER-TOP: 0px solid; BORDER-LEFT: 0px solid; BORDER-BOTTOM: 0px solid" cellSpacing=1 cellPadding=1 border=0 >
            ...
            <asp:Button ID="ButtonLogin" runat="server" OnClick="Add_Click" 
                Text="Add SO Payments" Width="160px" CssClass="auto-style11" BackColor="Black" BorderColor="Red" BorderWidth="3px" ForeColor="White" Height="45px"/>
            </td>
            </tr>
        </table>
 </div>
