<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AMPOPaymentAdd.aspx.cs" Inherits="KYMBusinessSolutions.AMPOPaymentAdd" %>
...
<form id="form1" runat="server">
        ...
        <table style="BORDER-RIGHT: 0px solid; BORDER-TOP: 0px solid; BORDER-LEFT: 0px solid; BORDER-BOTTOM: 0px solid" cellSpacing=1 cellPadding=1 border=0 >
            ...
            <strong>
                <asp:Label ID="lblPONumber" runat="server" Text="PONumber : "></asp:Label>
            </strong>
            </td>
             <td style="width: 180px; height: 45px">
            <asp:DropDownList ID="ddlPONumber" runat="server" Width="161px" BorderColor="Black" CssClass="auto-style19" Height="25px">
            </asp:DropDownList>
            </td>
            </tr>
            ...
            <td style="width: 180px; height: 45px">
            <asp:DropDownList ID="ddlSupplier" runat="server" Width="161px" BorderColor="Black" CssClass="auto-style19" Height="25px">
            </asp:DropDownList>
            </td>
            </tr>
            ...
            <asp:Button ID="ButtonLogin" runat="server" OnClick="Add_Click" 
                Text="Add PO Payments" Width="160px" CssClass="auto-style11" BackColor="Black" BorderColor="Red" BorderWidth="3px" ForeColor="White" Height="45px"/>
            </td>
            </tr>
        </table>
 </div>
